...
huron <- read.csv("../datasets/Huron_water_levels/huronLevel.csv")
str(huron)
...
# Create a Line Plot
plot(huron$Date,huron$Level,type="l",xlab="Year",ylab="Height (m)", main="Nishu analysis one for Lake Huron - Daily Water Levels")
